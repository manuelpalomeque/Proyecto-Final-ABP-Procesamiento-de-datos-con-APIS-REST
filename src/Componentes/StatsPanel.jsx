        ...
        <div className="flex flex-wrap -m-4 text-center">
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl">{props.cantProductos}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl">${props.precioTotalProductos}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl">${props.precioMax}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl ">${props.precioMin}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl">{props.cantProductosTitulo20}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl ">${props.promDescuentos}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
              ...
              <h2 className="title-font font-medium text-3xl ">${props.promPrecios}</h2>
          ...
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            ...
            >
              ...
              <h2 className="title-font font-medium text-3xl ">{props.stock}</h2>
